...
- add enabled_when lever to scope always-on file skills
...
- emit tracing span for skill routing decisions

### Fix

- key router cache on message and candidate set
- default skill router temperature to zero for stable routing
